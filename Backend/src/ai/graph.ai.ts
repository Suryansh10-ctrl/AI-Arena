...
const judgeNode: GraphNode<typeof state> = async (state) => {
    ...
    try {
        ...
        const judgeResponse = await judgeStructuredModel.invoke([
...
Please evaluate both solutions and output the scores and reasoning.
        ...
        if (judgeResponse) {
            return {
                judgeResult: {
                    solution_1_score: judgeResponse.solution_1_score ?? 5,
                    solution_2_score: judgeResponse.solution_2_score ?? 5,
